...
public class SelectPicPopupWindow extends PopupWindow {
     ...
     * @param itemsOnclick
     */
    public SelectPicPopupWindow(Activity context, int type,View.OnClickListener itemsOnclick){
        super(context);
        ...
        if (type==1){
            item_popupwindows_camera.setText("选取视频文件");
            item_popupwindows_Photo.setText("选取图片文件");
        }
        /**
         * 取消按钮销毁事件
         * by黄海杰@2015-1-7
