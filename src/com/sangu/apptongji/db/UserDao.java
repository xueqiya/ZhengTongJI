...
public class UserDao {
	...
	public static final String BLACK_COLUMN_NAME_ID = "username";
	public static final String BLACK_COLUMN_NAME_NICK = "nick";
	public static final String BLACK_NAME_INFO = "userInfo";
	public static final String BLACK_COLUMN_NAME_AVATAR = "avatar";
	 ...
	 * @param blackList
	 */
	public void saveBlackList(List<EaseUser> blackList) {
		DemoDBManager.getInstance().saveBlackList(blackList);
	}
