...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String BLACK_TABLE_CREATE = "CREATE TABLE "
            + UserDao.BLACK_TABLE_NAME + " ("
            + UserDao.BLACK_COLUMN_NAME_ID + " TEXT PRIMARY KEY, "
            + UserDao.BLACK_COLUMN_NAME_NICK + " TEXT, "
            + UserDao.BLACK_NAME_INFO+ " TEXT, "
            + UserDao.BLACK_COLUMN_NAME_AVATAR + " TEXT);";
