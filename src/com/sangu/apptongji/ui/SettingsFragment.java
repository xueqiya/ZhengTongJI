		...
		DemoHelper.getInstance().logout(false,new EMCallBack() {
			...
			public void onSuccess() {
				getActivity().runOnUiThread(new Runnable() {
					public void run() {
						pd.dismiss();
						SharedPreferences sp2 = getActivity().getSharedPreferences("sangu_denglu_info", Context.MODE_PRIVATE);
						...
						startActivity(new Intent(getActivity(), MainTwoActivity.class));
					}
				});
			}
