...
public class VoiceCallActivity extends CallActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		callType = 0;
        acatar = (ImageView) findViewById(R.id.swing_card);
    ...
    protected void setView() {
        ...
        if (!imageStr.equals("")) {
            ...
            ImageLoader.getInstance().displayImage(FXConstant.URL_AVATAR + images[0],acatar, DemoApplication.mOptions);
        }
    }
