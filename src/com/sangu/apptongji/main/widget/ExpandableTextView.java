...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.black_deep));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, ScreenshotUtil.sp2px(16));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.accent_blue));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, ScreenshotUtil.sp2px(16));
