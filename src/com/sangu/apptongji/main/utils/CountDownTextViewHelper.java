...
public class CountDownTextViewHelper {
     ...
     *            倒计时的间隔，单位是秒
     */
    public CountDownTextViewHelper(final TextView textView, int max, int interval) {
        ...
        countDownTimer = new CountDownTimer(max * 1000, interval * 1000 - 10) {
            ...
            public void onTick(long time) {
                ...
                mTextView.setText("1、接收短信大约需要"+((time + 15) / 1000) + "秒");
            ...
            public void onFinish() {
                ...
                mTextView.setText("1、收不到验证码?你可以尝试:");
                if (listener != null) {
                    listener.finish();
                }
            }
