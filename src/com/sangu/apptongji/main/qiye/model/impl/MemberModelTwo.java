...
public class MemberModelTwo implements IMemberModelTwo {
    private Context mcontext=null;
    public MemberModelTwo(Context context) {
        mcontext = context;
        RequestQueue queue = MySingleton.getInstance(mcontext.getApplicationContext()).getRequestQueue();
    }

    @Override
    public void getMemberList(final int currentPage,final OnQiyeListenerTwo onQiyeListener) {
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (memberInfoList.size()==20) {
                        onQiyeListener.onSuccess(memberInfoList,totalCompanyCount, true);
                    }else {
                        onQiyeListener.onSuccess(memberInfoList,totalCompanyCount, false);
                    }
