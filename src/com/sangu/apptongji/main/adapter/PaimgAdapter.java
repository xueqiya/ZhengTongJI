...
public class PaimgAdapter extends RecyclerView.Adapter<PaimgAdapter.ViewHolder>{
    ...
    public PaimgAdapter(List<UserAll> data,Context context,String lat,String lng) {
        this.lat = lat;
        this.lng = lng;
        this.data = data;
    }
    ...
    @Override
    public PaimgAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_find_fragment, parent, false);
        return new PaimgAdapter.ViewHolder(v,mItemClickListener,mItemLongClickListener);
    }
    ...
    @Override
    public void onBindViewHolder(PaimgAdapter.ViewHolder holder, int position) {
...
//            }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
        ...
        private PaimgAdapter.MyItemClickListener mListener;
        private PaimgAdapter.MyItemLongClickListener mLongClickListener;

        public ViewHolder(View convertView, PaimgAdapter.MyItemClickListener listener, PaimgAdapter.MyItemLongClickListener longClickListener) {
            super(convertView);
