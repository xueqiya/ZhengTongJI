...
public class ZhuFaListAdapter extends RecyclerView.Adapter<ZhuFaListAdapter.ViewHolder> {
    private List<ZhuFaDetail> data;
    private Context context;
    public MyItemClickListener mItemClickListener;
    public MyItemLongClickListener mItemLongClickListener;

    public ZhuFaListAdapter(List<ZhuFaDetail> data, Context context) {
        super();
        this.data = data;
        this.context = context;
    }

    public void appendData(List<ZhuFaDetail> list, Context context) {//分页关键
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final ZhuFaDetail allUser = data.get(position);
        if (allUser == null || data.size() == 0) {
            data.remove(position);
            this.notifyDataSetChanged();
        }
        holder.tvName.setText(TextUtils.isEmpty(allUser.getName()) ? allUser.getF_id() : allUser.getName());
        ...
        if (member==null||"".equals(member)||member.equalsIgnoreCase("null")){
            member = "0";
        }
        ...
        if (margan1!=null&&!margan1.equalsIgnoreCase("null")&&!"".equals(margan1) && Double.valueOf(margan1) > 0) {
        ...
        if (margan2!=null&&!margan2.equalsIgnoreCase("null")&&!"".equals(margan2) && Double.valueOf(margan2) > 0) {
        ...
        if (margan3!=null&&!margan3.equalsIgnoreCase("null")&&!"".equals(margan3) && Double.valueOf(margan3) > 0) {
        ...
        if (margan4!=null&&!margan4.equalsIgnoreCase("null")&&!"".equals(margan4) && Double.valueOf(margan4) > 0) {
        ...
        if (!(head==null||head.equals(""))) {
            ...
            holder.tvTitleA.setText(TextUtils.isEmpty(allUser.getName()) ? allUser.getF_id() : allUser.getName());
        }
        ...
        holder.ivHead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, UserDetailsActivity.class).putExtra(FXConstant.JSON_KEY_HXID,allUser.getF_id()));
            }
        });
