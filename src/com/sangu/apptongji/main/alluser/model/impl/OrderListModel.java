...
public class OrderListModel implements IOrderListModel {
    ...
    @Override
    public void getMerOrderList(final String id,final String state,final AsyncCallback callback) {
        String url = FXConstant.URL_OrderList;
    ...
    @Override
    public void getUserOrderList(final String id,final String state,final AsyncCallback callback) {
        String url = FXConstant.URL_OrderList;
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
