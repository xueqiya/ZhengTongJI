...
public class DianziDanJuTwoActivity extends BaseActivity implements View.OnClickListener,IDjDetailView{
    private IDjDetailPresenter presenter;
    private String biaoshi,title;
    private TextView tv_baocun;
    private EditText et_your_project,et_qianshou_dizhi,et_dingdan_bianhao;
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_dianzi_danju_two);
    ...
    private void sendPushMessage2(final String userId) {
        ...
        MySingleton.getInstance(DianziDanJuTwoActivity.this).addToRequestQueue(request);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.tv_baocun:
                if (isBaocun){
                    String biaoti = et_your_project.getText().toString().trim();
                    String neirong = et_qianshou_dizhi.getText().toString().trim();
                    String order_number = et_dingdan_bianhao.getText().toString().trim();
                    ...
                    LayoutInflater inflater1 = LayoutInflater.from(DianziDanJuTwoActivity.this);
                    RelativeLayout layout1 = (RelativeLayout) inflater1.inflate(R.layout.dialog_alert, null);
                    final Dialog dialog1 = new AlertDialog.Builder(DianziDanJuTwoActivity.this,R.style.Dialog).create();
                    dialog1.show();
                    ...
                    final String finalNeirong = neirong;
                    final String finalBiaoti = biaoti;
                    final String finalOrder_number = order_number;
                    btnOK1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if ("00".equals(biaoshi)) {
                                ...
                                params.add(new Param("content", finalNeirong));
                                params.add(new Param("title", finalBiaoti));
                                params.add(new Param("order_number", finalOrder_number));
                                params.add(new Param("flag", "02"));
                            }else {
                    ...
                    LayoutInflater inflaterDl = LayoutInflater.from(DianziDanJuTwoActivity.this);
                    RelativeLayout layout = (RelativeLayout) inflaterDl.inflate(R.layout.layout_order_send, null);
                    final Dialog dialog = new AlertDialog.Builder(DianziDanJuTwoActivity.this,R.style.Dialog).create();
                    dialog.show();
                    ...
                    re_item1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            dialog.dismiss();
                            PermissionUtil permissionUtil = new PermissionUtil(DianziDanJuTwoActivity.this);
                            permissionUtil.requestPermissions(new String[]{Manifest.permission.READ_CONTACTS},
                                    new PermissionListener() {
                                        @Override
                                        public void onGranted() {
                                            //所有权限都已经授权
                                            Intent intent = new Intent(DianziDanJuTwoActivity.this,AddressListTwoActivity.class);
                    ...
                    re_item2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            dialog.dismiss();
                            Intent intent3 = new Intent(DianziDanJuTwoActivity.this,FriendActivity.class);
            ...
            case R.id.btn_tianjia:
                if (current_neirong<4) {
                    ...
                    Toast.makeText(DianziDanJuTwoActivity.this,"最多添加八个签名哦...",Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.btn_quxiao:
                if (current_neirong>1) {
                    ...
                    if (current_neirong==1){
                        if ((image3!=null&&!"".equals(image3))||(image4!=null&&!"".equals(image4))){
                            Toast.makeText(DianziDanJuTwoActivity.this,"没有可以取消的内容了...",Toast.LENGTH_SHORT).show();
                        }else {
                ...
                break;
            case R.id.tv_sign1:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),1);
                break;
            case R.id.iv_sign1:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),1);
                break;
            case R.id.tv_sign2:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),2);
                break;
            case R.id.iv_sign2:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),2);
                break;
            case R.id.tv_sign3:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),3);
                break;
            case R.id.iv_sign3:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),3);
                break;
            case R.id.tv_sign4:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),4);
                break;
            case R.id.iv_sign4:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),4);
                break;
            case R.id.tv_sign5:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),5);
                break;
            case R.id.iv_sign5:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),5);
                break;
            case R.id.tv_sign6:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),6);
                break;
            case R.id.iv_sign6:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),6);
                break;
            case R.id.tv_sign7:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),7);
                break;
            case R.id.iv_sign7:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),7);
                break;
            case R.id.tv_sign8:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),8);
                break;
            case R.id.iv_sign8:
                startActivityForResult(new Intent(DianziDanJuTwoActivity.this,QianMingActivity.class).putExtra("biaoshi","22"),8);
                break;
    ...
    public void updateDzdjDetail(DianziDanju djDetail) {
        ...
        String order_number = djDetail.getOrder_number();
        ...
        et_your_project.setText(title);
        et_qianshou_dizhi.setText(count);
        et_dingdan_bianhao.setText(order_number);
