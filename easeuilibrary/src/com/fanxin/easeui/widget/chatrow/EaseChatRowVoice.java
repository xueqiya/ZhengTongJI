...
public class EaseChatRowVoice extends EaseChatRowFile{
    ...
    public EaseChatRowVoice(Context context, EMMessage message, int position, BaseAdapter adapter, EMConversation emConversation) {
    ...
    public void onBubbleClick() {
        new EaseChatRowVoicePlayClickListener(message, voiceImageView, readStatusView, adapter, activity,position,conversation).onClick(bubbleLayout);
    }
