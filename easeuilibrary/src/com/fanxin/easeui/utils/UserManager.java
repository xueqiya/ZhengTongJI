...
import com.fanxin.easeui.bean.Msg;
import com.fanxin.easeui.listener.OnCallStateListener;
...
//    private String domain = "http://10.38.162.149/";
    ...
    public interface OnHandleMIMCMsgListener {
        void onHandleMessageObjec(com.alibaba.fastjson.JSONObject jsonObject);
    ...
    public void sendMsg(String toAppAccount, byte[] content, int msgType, Map<String,Object> map) {
        Msg msg = new Msg();
        ...
        if (msgType == Constant.PING) {
            ...
            mUser.sendMessage(toAppAccount, json2.getBytes());
     ...
     * @return 返回新创建的用户
     */
    public MIMCUser newUser(String appAccount, Context context){
        ...
        mUser = MIMCUser.newInstance(appAccount, context.getExternalFilesDir(null).getAbsolutePath());
        // staging
        ...
        public void handleMessage(List<MIMCMessage> packets) {
            for (int i = 0; i < packets.size(); ++i) {
                ...
                try {
                    ...
                    com.alibaba.fastjson.JSONObject object = JSON.parseObject(new String(mimcMessage.getPayload()));
                    ...
                    if (msg.getMsgType() == Constant.TEXT) {
                     ...
                     //   addMsg(chatMsg);
                       ...
                       // String strUTF8 = URLDecoder.decode(content1, "UTF-8");


                        String str2 = new String(Base64.decode(object.getString("content")));

                       // String content = new String(chatMsg.getMsg().getContent());
                        object.put("content",str2);

                        onHandleMIMCMsgListener.onHandleMessageObjec(object);
